  ...
  function mount(container) {
    ...
    container.innerHTML = `
      <header class="section-head" data-reveal>
        ...
        <p class="section-sub">One paper contract at the buy price in the first saved snapshot that met the entry rule at the time. These are simulated trades, with outcomes from Kalshi.</p>
      </header>
